...
describe AlbumsController do
    ...
    describe "PUT update" do
      describe "with valid params" do
        it "updates the requested album" do
          ...
          put :update, {:id => album.to_param, :album => { "title" => "MyString" }}
        end

        it "assigns the requested album as @album" do
          album = Album.create! attributes_for(:album)
          put :update, {:id => album.to_param, :album => attributes_for(:album)}
          assigns(:album).should eq(album)
        end
      ...
      describe "with invalid params" do
        it "assigns the album as @album" do
          ...
          # Trigger the behavior that occurs when invalid params are submitted
          Album.any_instance.stub(:save).and_return(false)
          put :update, {:id => album.to_param, :album => { "title" => "invalid value" }}
          assigns(:album).should eq(album)
        end
  ...
  describe "guest access to albums" do
    ...
    describe "DELETE#destroy" do
      it "requires login" do
        album = Album.create! attributes_for(:album)
        delete :destroy, {:id => album.to_param, :album => { "title" => "MyString" }}
        response.should redirect_to(new_user_session_url)
      end
    end
  end
